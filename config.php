...
function balance($API_KEY){
    ...
    $response = @file_get_contents('https://openai-proxy.cgweb.top/dashboard/billing/credit_grants', false, $context);
...
function completions($API_KEY,$TEXT)
{
    ...
    $context = stream_context_create($options);
    $response = @file_get_contents('https://openai-proxy.cgweb.top/v1/completions', false, $context);
...
function imges($API_KEY,$TEXT)
{
    ...
    $context = stream_context_create($options);
    $response = @file_get_contents('https://openai-proxy.cgweb.top/v1/images/generations', false, $context);
